...
const postBoxIconColor = Color(0xFF404041);
// const themeColor=Color(0xFF14C0DC);
const themeColor = Color(0xFFFCFCFF);
...
const lightRedColor = Color(0xFFFF6054);
const darkRedColor = Color(0xFFf16056);
